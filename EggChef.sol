...
// EggChef is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterChef.
contract EggChef {
    using SafeMath for uint256;
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many EGG tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws EGG tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes Egg tokens.
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = egg.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 eggSupply = egg.balanceOf(address(this));
        if (eggSupply == 0) {
        ...
        poolInfo.accRewardPerShare = poolInfo.accRewardPerShare.add(tokenReward.mul(1e12).div(eggSupply));
        poolInfo.lastRewardBlock = block.number;
    }


    // Deposit Egg tokens to EggChef for Reward allocation.
    function deposit(uint256 _amount) public {
        require (_amount > 0, 'amount 0');
        UserInfo storage user = userInfo[msg.sender];
        updatePool();
        egg.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    // Withdraw Egg tokens from EggChef.
